    ...
    public partial class musteri : Form
    {
        ...
        void uygunaracdoldur2()
        {
            ...
            try
            {
                ...
                dt.Clear();
                OleDbDataAdapter listele = new OleDbDataAdapter("select * from arac where durum='" + "Uygun" + "'", baglanti);
                listele.Fill(dt);
                dataGridView1.DataSource = dt;
                listele.Dispose();
                dataGridView1.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
        ...
        void uygunaracdoldur()
        {
            try
            {
                ...
                dt.Clear();
                OleDbDataAdapter listele = new OleDbDataAdapter("select * from arac where satis_durum='" + "Satışa Uygun" + "'", baglanti);
                listele.Fill(dt);
                dataGridView1.DataSource = dt;
                listele.Dispose();
                dataGridView1.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
