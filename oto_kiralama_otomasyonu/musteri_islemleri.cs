...
namespace oto_kiralama_otomasyonu
{
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (cevap == DialogResult.Yes && dataGridView1.CurrentRow.Cells[0].Value.ToString().Trim() != "")
            {
                try
                {
                    ...
                    OleDbCommand sil = new OleDbCommand("delete from musteri where tc='" + dataGridView1.CurrentRow.Cells[1].Value.ToString() + "'", baglanti);
                    sil.ExecuteNonQuery();
   ...
   ;
        ...
        private void textBox7_TextChanged(object sender, EventArgs e)
        {
                ...
                OleDbDataAdapter adtr = new OleDbDataAdapter("select * From musteri where tc like'%" + textBox7.Text + "%'or adi_soyadi like '%" + textBox7.Text + "%'or cinsiyet like '%" + textBox7.Text + "%'or telefon like '%" + textBox7.Text + "%'or dogum_tarihi like '%" + textBox7.Text + "%'", baglanti);
                adtr.Fill(dt);
                dataGridView1.DataSource = dt;
                adtr.Dispose();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            OleDbCommand adtr = new OleDbCommand("UPDATE musteri set tc='"+maskedTextBox1.Text+"',adi_soyadi='"+textBox2.Text+"',cinsiyet='"+textBox3.Text+"',telefon='"+textBox4.Text+"',dogum_tarihi='"+textBox5.Text+"',ehliyet_no='"+textBox6.Text+ "'where tc='" + dataGridView1.CurrentRow.Cells[1].Value.ToString() + "'", baglanti);
