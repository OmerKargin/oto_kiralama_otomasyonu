...
namespace oto_kiralama_otomasyonu
{
    public partial class arac_satis : Form
    {
        ...
        void uygunaracdoldur()
        {
            ...
            OleDbCommand komut = new OleDbCommand("select plaka from arac where satis_durum='" + "Satışa Uygun" + "'", baglanti);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                OleDbCommand komut = new OleDbCommand("insert into arac_satis(tc,plaka,alis_tarihi,veris_tarihi,ucret) values('" + comboBox1.Text + "','" + comboBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "')", baglanti);
                //
                // 
                if (baglanti.State == ConnectionState.Closed)
                {
        ...
        private void textBox7_TextChanged(object sender, EventArgs e)
        {
            ...
            OleDbDataAdapter adtr = new OleDbDataAdapter("select * From arac_satis where tc like'%" + textBox7.Text + "%'or plaka like '%" + textBox7.Text + "%'or alis_tarihi like '%" + textBox7.Text + "%'or veris_tarihi like '%" + textBox7.Text + "%'or ucret like '%" + textBox7.Text + "%'", baglanti);
            adtr.Fill(dt);
            dataGridView1.DataSource = dt;
            adtr.Dispose();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (cevap == DialogResult.Yes && dataGridView1.CurrentRow.Cells[0].Value.ToString().Trim() != "")
            {
                try
                {
                    ...
                    OleDbCommand sil = new OleDbCommand("delete from arac_satis where plaka='" + dataGridView1.CurrentRow.Cells[2].Value.ToString() + "'", baglanti);
                    sil.ExecuteNonQuery();
                    uygunaracdoldur();
                    musteridoldur();
        ...
        {
            OleDbCommand komut = new OleDbCommand("update arac_satis set tc='" + comboBox1.Text + "',plaka='" + comboBox2.Text + "',alis_tarihi='" + textBox3.Text + "',veris_tarihi='" + textBox4.Text + "',ucret='" + textBox5.Text + "' where plaka='" + dataGridView1.CurrentRow.Cells[2].Value.ToString() + "'", baglanti);
            // 
            if (baglanti.State == ConnectionState.Closed)
            {
                baglanti.Open();
